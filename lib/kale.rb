...
module Kale
  class Kele
    ...
    def create_submission(checkpoint_id, assignment_branch, assignment_commit_link, comment)
      ...
      return self.class.post('https://www.bloc.io/api/v1/checkpoint_submissions',
                                 query: { "assignment_branch": assignment_branch, "assignment_commit_link": assignment_commit_link, "checkpoint_id": checkpoint_id, "comment": comment, "enrollment_id": enrollment_id },
                                 headers: { content_type: 'application/json', authorization: @auth_token })
    end
  end
end
